...
// TODO set an empty obj
// TODO destructure array to get category, price and quantity
// TODO count revenue and item


const totalSalesByCategory = sales.reduce ((table, sale) => {
   const {category, price, quantity} = sale;    // destructure
